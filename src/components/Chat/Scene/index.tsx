...
import { Stage, useAnimations, useGLTF, Html } from "@react-three/drei";
...
export const Scene = () => {
  return (
    <Canvas shadows>
      <Suspense
        fallback={
          <Html className="w-full h-full bg-[]">
            <svg
              aria-hidden="true"
              className="w-8 h-8 mr-2 text-[#FFFFFF80] animate-spin dark:[#FFFFFF80] fill-blue-600"
              viewBox="0 0 100 101"
              fill="none"
