...
export type ValueTypes = {
  ["Mutation"]: AliasType<{
    createBotDialogue?: [
      {
        dialogueId?: string | undefined | null | Variable<any, string>;
        userPayload: ValueTypes["DialogueInput"] | Variable<any, string>;
        botPayload: ValueTypes["DialogueInput"] | Variable<any, string>;
      },
      boolean | `@${string}`
    ];
    reactOnConversation?: [
      {
        conversationId: string | Variable<any, string>;
        reaction: boolean | Variable<any, string>;
      },
      boolean | `@${string}`
    ];
...
export type ResolverInputTypes = {
  ["Mutation"]: AliasType<{
    createBotDialogue?: [
      {
        dialogueId?: string | undefined | null;
        userPayload: ResolverInputTypes["DialogueInput"];
        botPayload: ResolverInputTypes["DialogueInput"];
      },
      boolean | `@${string}`
    ];
    reactOnConversation?: [
      { conversationId: string; reaction: boolean },
      boolean | `@${string}`
    ];
    testEndpoint?: boolean | `@${string}`;
    useFineTuneJob?: boolean | `@${string}`;
